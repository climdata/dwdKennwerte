...
require("ggplot2")
mp <- ggplot()
mp + geom_line(aes(y=clim$summerPrecipitation, x=clim$year), color="blue") + 
     geom_line(aes(y=20*clim$heavyRainDays, x=clim$year), color="red")


mp <- ggplot()
mp + geom_point(aes(y=clim$summerPrecipitation, x=clim$heavyRainDays), color="blue")
